    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        if(savedInstanceState == null){
            ...
            getSupportFragmentManager().beginTransaction()
                    ...
                    .add(R.id.def_record_field4, TextFieldFragment.class, bundles[0])
                    .add(R.id.def_record_field5, TextFieldFragment.class, bundles[1])
                    .add(R.id.def_record_field6, TextFieldFragment.class, bundles[2])
                    .add(R.id.def_record_field7, TextFieldFragment.class, bundles[3])
                    .add(R.id.def_record_field8, TextFieldFragment.class, bundles[4])
                    .add(R.id.def_record_field9, TextFieldFragment.class, bundles[5])
                    .add(R.id.def_record_field10, TextFieldFragment.class, bundles[6])
                    .add(R.id.def_record_field11, TextFieldFragment.class, bundles[7])
                    .add(R.id.def_record_field12, TextFieldFragment.class, bundles[8])
                    .add(R.id.def_record_field13, TextFieldFragment.class, bundles[9])
                    .add(R.id.def_record_field14, TextFieldFragment.class, bundles[10])
                    .add(R.id.def_record_field15, TextFieldFragment.class, bundles[11])
                    .add(R.id.def_record_field16, TextFieldFragment.class, bundles[12])
                    .add(R.id.def_record_field17, TextFieldFragment.class, bundles[13])
                    .commit();
